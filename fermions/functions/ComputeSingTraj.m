function [obs wf]=ComputeSingTraj(Evolution,ApplyJump,in,psi0,op)

global r;

% Initialise the variables
[obs wf]=InitializeObs(in,op);

% initialize
nj=0;

% compute the observables on the initial state
obs=ComputeObs(1,psi0,op,obs,in);
obs.countj(1,:)=0;
obs.overlap(1,1)=1;
...
for it=1:in.tsteps-1
    ...
    obs=ComputeObs(it+1,wfnew,op,obs,in);
